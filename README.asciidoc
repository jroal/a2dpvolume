...
The A2DP Connect widget has now (since version 2.13.0.0) been integrated into this app.  This allows you to place Bluetooth device connect/disconnect toggle buttons on your hoescreen to allow simple one-click connecting to a Bluetooth A2DP sink.  More detials here: https://github.com/jroal/a2dp-connect2
